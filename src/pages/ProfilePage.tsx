      ...
      >
        ...
        <div className="relative z-10 my-auto flex w-full max-w-[440px] min-h-[500px] sm:min-h-[660px] max-h-[90vh] flex-col justify-between gap-3.5 rounded-[24px] sm:rounded-[26px] border-[3px] border-[#3e2211] bg-gradient-to-b from-[#945525]/95 via-[#753f1a]/95 to-[#54290c]/95 p-3.5 xs:p-4 sm:p-6 text-[#fff3cd] shadow-[inset_0_2px_0_rgba(255,226,162,0.6),inset_0_-4px_0_rgba(30,12,4,0.7),0_8px_0_#381c0d,0_20px_40px_rgba(5,15,5,0.75)] backdrop-blur-md overflow-y-auto custom-scrollbar">
          ...
          <div className="flex items-center justify-between pb-1.5 border-b border-[#8a4e22]/50">
            ...
            <div className="rounded-full border-2 border-[#3d200e] bg-gradient-to-b from-[#d99043] to-[#8c4b18] px-3.5 sm:px-4 py-0.5 text-[9.5px] sm:text-[11px] font-black uppercase tracking-wider sm:tracking-widest text-[#fff3cd] shadow-[inset_0_1px_0_rgba(255,255,255,0.6),0_2px_0_#2b1408]">
              PLAYER PROFILE
            </div>
